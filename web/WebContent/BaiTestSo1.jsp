			...
			<div class="box-multiChoice">
						...
						<div class="ql-row">
							...
							<div class="ct-right">
								...
								<div class="ctr-choice" style=''>
									<span class="sp-choice"> Chọn <b>1</b> câu trả lời đúng
									</span>
									<table id="ctl15_rptCauHoi_ctl00_rbtnList" class="input"
										border="0">
										<tr>
											<td><span class="rd"><input
													id="ctl15_rptCauHoi_ctl00_rbtnList_<%=q.getNumber() %>_0"
													type="radio" name="ans[<%=q.getNumber()%>]" value="A" /> <label
													for="ctl15_rptCauHoi_ctl00_rbtnList_<%=q.getNumber() %>_0">A:
														<%=q.getOption1() %></label></span></td>
										</tr>
										<tr>
											<td><span class="rd"><input
													id="ctl15_rptCauHoi_ctl00_rbtnList_<%=q.getNumber() %>_1"
													type="radio" name="ans[<%=q.getNumber() %>]" value="B" />
													<label
										...
										<tr>
											<td><span class="rd"><input
													id="ctl15_rptCauHoi_ctl00_rbtnList_<%=q.getNumber() %>_2"
													type="radio" name="ans[<%=q.getNumber() %>]" value="C" />
													<label
										...
										<tr>
											<td><span class="rd"><input
													id="ctl15_rptCauHoi_ctl00_rbtnList_<%=q.getNumber() %>_3"
													type="radio" name="ans[<%=q.getNumber() %>]" value="D" />
													<label
				...
				<div id="ctl15_pnStart">
					...
					<div class="bm-test-again">
						...
						<input type="hidden" name="minutesubmit" id="minutesubmit"
							value=""> <input type="hidden" name="secondsubmit"
							id="secondsubmit" value=""> <input type="hidden"
							name="command" value="nopbai"> <input type="hidden"
							name="quiz_id" value="<%=quiz.getId()%>"> <input
							type="hidden" name="TokenCSRF_Thi_NopBai"
							value="A01BDD2E459BCE3EF490BC2F9FF779880D17A320D13D9E7BB97908E2942997EBEE17A055CBAEA4D61F0CB4C1EB87D52969CACF8D3107C2C4600139D3DD11ADB7">
						<a onclick="if ( ! FinishConfirmation()) return false;"
							id="ctl15_btnNopBai" class="bm-test-again-lnk"
							href="javascript:__doPostBack()"> NỘP BÀI </a> <input
							type="submit" name="ctl15$btn" value="" id="ctl15_btn"
