          ...
          <div class="col-md-3"> 
            <div id="desktop-menu">
              <div class="panel panel-default"><h4 id="mobile_home">Hướng dẫn sử dụng</h4>
                <div>
                    <a href="HuongDanSuDung.html" class="list-group-item active1" ><span class="pull-right" ><i class="icon-chevron-right"></i></span >Giới thiệu</a>

                     <a href="ThacMac.jsp" class="list-group-item "><span class="pull-right"><u class="icon-chevron-right">
                     </i></span>Thắc mắc</a>
                     <a href="SuDungTaiLieu.jsp" class="list-group-item "><span class="pull-right"><i class="icon-chevron-right"></i></span>Sử dụng tài liệu</a>

                      <a href="LienHe.jsp" class="list-group-item "><span class="pull-right"><i class="icon-chevron-right"></i></span>Liên hệ</a>    
                </div>
              </div><!-- /panel-default -->
            </div><!--desktop menu-->
          </div><!--colmd 3-->
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
                <div  style="color: rgb(7, 132, 163);" class="panel-heading">
                    <h4 style="font-family: verdana;color:rgb(87,87,87);">Các thông tin</h4>
                </div>
                        <div class="panel-body"><!--Các bản tin-->
                            <ul class="list-unstyled" > 
                                  ...
                                  <li class="article-area" style= "color:rgb(0,183,178);"">
                                      ...
                                      Trang  Sudy Funny là trang web hỗ trợ  việc học tập của sinh viên cũng như hỗ trợ dạng dạy trực tuyến.</h4> </p>
                                      <h4> 
                                      <p>Đây là một trong những trang được đánh giá tốt và đã được sử dụng tại nhiều trường đại học</p> </h4> 
                                     
                                  </li><a href="../thong-bao-1.html">
                              </a>
            
                              <a href="trang-chu.html">
                                  <li class="article-area">
                                      <p style="color:rgb(0,183,178);">
                                      <span class="btn btn-success ">Trở về trang chủ</span>                                     
                                      </p>
                                  </li>
                              </a>
                            </ul>
