...
<link rel="stylesheet" href="css/khanh.css" type="text/css">
 <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<title>HÆ°á»ng dáº«n jQuery</title> 
...
<div id="wrapper">
 ...
 <a href="#" id="load-du-lieu" >XEM TIN TỨC TẠI ĐÂY</a>
 <br>
 </div>
 <div style="margin-left: 200px; margin-right: 200px; margin-top:20px" id="noidung">
...
<button id="btn">Click here</button>
		 ...
		 <script type="text/javascript">
			$(document).ready(function(){
				  $("#btn").click(function(){
				 	$("#noidung").load("ajax2.html #eobit,script");
				  });
			})
		 </script>
