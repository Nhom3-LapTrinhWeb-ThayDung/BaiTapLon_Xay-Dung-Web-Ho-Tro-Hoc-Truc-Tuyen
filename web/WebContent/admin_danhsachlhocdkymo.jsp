...
<!--
    ...
    <div id="header-menu" style="background: rgb(0, 183, 178);">
        ...
        <ul class="ul-menu-header">
            <li class="li-menu-header"><a class="lnk-menu-header">HỌC VIÊN </a>           
            </li>  
...
<div id="body">
      ...
      <td class="studyprogram_tabledetails_td_header_dl" width="30%">Tên khoá học</td>
      <td class="studyprogram_tabledetails_td_header_dl" width="20%">Mã giảng viên</td>
      <td class="studyprogram_tabledetails_td_header_dl" width="10%">Giới hạn </br>số lương</td>
      <td class="studyprogram_tabledetails_td_header_dl" width="20%">Số lương sinh viên</br>đăng ký</td>
      <td class="studyprogram_tabledetails_td_header_dl" width="6%">Xoá</td></tr>

      <tr>
      <td class="studyprogram_tabledetails_td_content_dl">&nbsp;1</td>
      <td class="studyprogram_tabledetails_td_content_dl">&nbsp;CNPMTTT</td>
      <td class="studyprogram_tabledetails_td_content_dl">&nbsp;Công nghệ phần mềm</td>
      <td class="studyprogram_tabledetails_td_content_dl">&nbsp;GVTM0001</td>
      <td class="studyprogram_tabledetails_td_content_dl">&nbsp;50</td>
      <td class="studyprogram_tabledetails_td_content_dl">&nbsp;28</td>
      <td class="studyprogram_tabledetails_td_content_dl"><a href=""">Xoá</a></td></tr>
      <tr>
      <td class="studyprogram_tabledetails_td_content_dl">&nbsp;1</td>
      <td class="studyprogram_tabledetails_td_content_dl">&nbsp;CNPMTTT</td>
      <td class="studyprogram_tabledetails_td_content_dl">&nbsp;Công nghệ phần mềm</td>
