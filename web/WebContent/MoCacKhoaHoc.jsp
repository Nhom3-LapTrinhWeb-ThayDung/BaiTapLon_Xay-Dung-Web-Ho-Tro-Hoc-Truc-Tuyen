...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"><title>
    ...
    <link href="http://www.viettelstudy.vn/" rel="canonical">
        <link href="http://www.viettelstudy.vn/" rel="canonical">
<link href="C:\Users\Khanh\Downloads\Compressed\bootstrap-3.3.7-dist\bootstrap-3.3.7-dist\css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="js/jquery-3.1.1.min.js">
</head>
<body>
...
<!--P>Bắt đầu thêm dữ liệu ở đây</P-->
          ...
          <div class="col-md-3"> 
            <div id="desktop-menu">
              <div class="panel panel-default">
                ...
                <div>
                    <a href="GiangVien.html" class="list-group-item " ><span class="k1" ><i class="icon-chevron-right"></i></span >Thông tin cá nhân</a>

                     <a href="ThacMac.html" class="list-group-item active1"><span class="pull-right"><u class="icon-chevron-right">
                     </i></span> Mở các khóa học</a>

                     <a href="SuDungTaiLieu.html" class="list-group-item "><span class="pull-right"><i class="icon-chevron-right"></i></span>Danh sách khóa học</a>
                      <a href="LienHe.html" class="list-group-item "><span class="pull-right"><i class="icon-chevron-right"></i></span>Gửi phản hồi cho admin</a>    
                </div>
              </div><!-- /panel-default -->
            </div><!--desktop menu-->
          </div><!--colmd 3-->
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
                <div  style="color: rgb(7, 132, 163);" class="panel-heading">
                    <h4 style="font-family: verdana;color:green">Tên các khóa học</h4>
                </div>
                <div class="panel-body"><!--Các bản tin-->
                   <ul class="list-unstyled" > 
                   <a href="../thong-bao-1.html"></a>
                   <a href="trang-chu.html">
                      <li class="article-area">
                          <p class=hhhh">
                            <span class="btn btn-success bnt-hhhh "> Công nghệ phần mềm</span>            
                          </p>

                          <p style="color:rgb(0,183,178);">
                            <span class="btn btn-success  "> Kỹ thuật điện</span>            
                          </p>

                          <p style="color:rgb(0,183,178);">
                            <span class="btn btn-success "> Anh văn chuyên ngành</span>            
                          </p>

                          <p style="color:rgb(0,183,178);">
                            <span class="btn btn-success "> Tin học căn bản</span>            
                          </p>
                      </li>
                   </a>
