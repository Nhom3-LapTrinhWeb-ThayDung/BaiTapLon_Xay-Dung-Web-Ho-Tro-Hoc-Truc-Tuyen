...
<body>
    <form name="form1" method="post" action="canhangiangvien.html" id="form1" enctype="multipart/form-data">
<div>
...
<div id="header">
    ...
    <div id="header-menu" style="background: rgb(0, 183, 178);">
        <a class="lnk-hm-home" href="http://viettelstudy.vn/index.html">
        </a>
...
#doimk {
    display: none;
        ...
        <img src="http://media.viettelstudy.vn/" alt="" class="persion-avatar-img">
        <h3 class="persion-info">
            <span class="bold">
                Nguyễn Ngọc Hải</span><br>
        </h3>
            ...
            <div class="persion-tab">
                <div class="wrap-tab">
                    <a class="persion-tab-lnk lnk-tab-info active" name="DetailUser" href="#DetailUser" onclick="loadUserControl('ThongTinCaNhanNew')">
                        <span>Thông tin cá nhân</span> </a>
                        <!--<a class="persion-tab-lnk" name="skhoahocdangday" href="#dskhoahocdangday">
                        <span>Danh sách khóa học đang dạy</span>
                    </a>-->
                    <a class="persion-tab-lnk lnk-tab-persion" name="TienTrinhHocNew">
                        <span>Danh sách khóa học đang dạy</span>
                        </a>
                    <a class="persion-tab-lnk" name="DetailThi">
...
<div class="persion-right persion-detail" id="TienTrinhHocNew" style="display: none;"><h3 class="learn-process-h3">
    <span>DANH SÁCH KHÓA HỌC ĐANG DẠY</span>
</h3>
 <style>
                ...
                <div class="to-c-left">
                   <div class="to-c-l-list">
                                ...
                                <div class="row">
                                    ...
                                    <a  href='khoahoc.html#ktlt' name="2">
                                        <p class="to-l-p-name">
                                            <span class="bold">
            ...
            <div id="ctl14_ThongTinHocVien_pnInfo">
                    ...
                    <div class="bpt-row">
                        ...
                        <div class="bpt-item-right">
                            <input name="ctl14$ThongTinHocVien$txtTenDayDu" type="text" value="Nguyễn Ngọc Hải" maxlength="100" id="ctl14_ThongTinHocVien_txtTenDayDu" class="bpt-txt">
        ...
        <option value="2011">2011</option>
                    ...
                    <div class="bpt-row">
                        ...
                        <div class="bpt-item-right">
                            ...
                            <select name="ctl14$ThongTinHocVien$ddlGioiTinh" id="ctl14_ThongTinHocVien_ddlGioiTinh" class="bpt-sl-sex">
                            <option selected="selected" value="0">Giờ</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                            <option value="4">4</option>
                            ...
                            <select name="ctl14$ThongTinHocVien$ddlGioiTinh" id="ctl14_ThongTinHocVien_ddlGioiTinh" class="bpt-sl-sex">
                            <option selected="selected" value="0">Phút</option>
                    ...
                    <div class="bpt-row">
                        <div class="bpt-item-left">
                            Địa điểm học:</div>
                        <div class="bpt-item-right">
                            <input name="ctl14$ThongTinHocVien$txtTenDayDu" type="text" maxlength="100" id="ctl14_ThongTinHocVien_txtTenDayDu" class="bpt-txt">
                            <span id="ctl14_ThongTinHocVien_lblErrTenDayDu"></span>
                        </div>
                    </div>
                    ...
                    <div class="bpt-row">
                        <div class="bpt-item-left">
                            Mô tả:</div>
                        <div class="bpt-item-right">
                            <textarea class="txt-input" name="txtAddedContent" style="height:100px;width: 250px;" id="txtAddedContent" placeholder="Nội dung"></textarea>
                        </div>
                    </div>
...
<div style="float:left;padding-left:8px;padding-right:20px">
    <img class="capcha" src="http://viettelstudy.vn/uControls/Capcha/capchaImage.aspx?len=5&amp;id=StepLogin" title="Lấy mã khác" alt="ViettelStudy"> 
            ...
            <input type="hidden" name="TokenCSRF_Canhan" value="2BAA3CD3A4585B655BAF137E975E7DFB1113F7F1A3EC1EBA215CD641911491FF4531083F7B50F51CAD86663991A3CB54FD6410C064C61EF30C232ABAAA2A73B6">
        </div>
        <!--end-edit-user---->
    </div>
</div>
...
<div style="display: block;" class="bpt-content" id="doimk">
    ...
    <div class="bpt-row bpt-row-save" style="margin-top:0px;">
        ...
        <input type="hidden" name="TokenCSRF_Doimk" value="F1CF4C77CE1C09A32DD6BFE41A41A638CAE5A5A9EC423F90CB6D6858647664589ECFD6FCB25DAE392852A33A114552FB83150825346022B246D482F8B93E6A5C">
    </div>
            ...
            <div id="ctl14_ThongTinHocVien_pnInfo">
                    ...
                    <div class="bpt-row">
                        <div class="bpt-item-left">
                            Số điện thoại:</div>
                        <div class="bpt-item-right">
                            <input name="ctl14$ThongTinHocVien$txtTaiKhoan" type="text" value="841678868567" maxlength="15" id="ctl14_ThongTinHocVien_txtTaiKhoan" class="bpt-txt">
                        </div>
                    </div>
                    <div class="bpt-row">
                        <div class="bpt-item-left">
        ...
        <option value="2011">2011</option>
            ...
            <div class="bpt-row">
                <div class="bpt-item-left">
                    Địa chỉ:</div>
                <div class="bpt-item-right">
                    <input name="ctl14$ThongTinHocVien$txtLop" type="text" maxlength="200" id="ctl14_ThongTinHocVien_txtLop" class="bpt-txt">
                </div>
            </div>
            <div class="bpt-row">
                <div class="bpt-item-left">
            ...
            <div id="login_pnLogin">
                    ...
                    <div class="bpc-row" style="margin-top: 0px;">
                        <span class="sp-left"></span><span class="sp-right">
                            ...
                            <input type="hidden" name="TokenCSRF_Login" value="47856F874954C46BBA4B080196E7DAE2605598C0EC7BF471041A35027851289894EE9541446422F23E435CFEDB9F9E49AA9661D750599A3E1AAE575855F78583">
                        </span>
