              ...
              <div class="panel panel-default"><h4 id="mobile_home">Hướng dẫn sử dụng</h4>
                <div>
                    <a href="HuongDanSuDung.html" class="list-group-item " ><span class="k1" ><i class="icon-chevron-right"></i></span >Giới thiệu</a>
                     <a href="ThacMac.html" class="list-group-item "><span class="pull-right"><u class="icon-chevron-right">
                     </i></span>Thắc mắc</a>
                     <a href="SuDungTaiLieu.html" class="list-group-item active1"><span class="pull-right"><i class="icon-chevron-right"></i></span>Sử dụng tài liệu</a>
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
                <div  style="color: rgb(7, 132, 163);" class="panel-heading">
                    <h4 style="font-family: verdana;color:rgb(87,87,87);">Cách sử dụng tài liệu đúng cách</h4>
                </div>
                        <div class="panel-body"><!--Các bản tin-->
                            <ul class="list-unstyled" > 
                                  ...
                                  <li class="article-area" style= "color:rgb(0,183,178);"">
                                      ...
                                      Đây là trang hoạt động nội bọ, không được phép share tài liệu dưới bất kì hình thức nào khi chưa được sự đồng ý của quán trị viên.</h4> </p>
                                     
                                  </li><a href="../thong-bao-1.html">
                              </a>
                              <p><h4>Bạn cần đăng nhập để tải tài liệu</h4></p>
                              <a href="DangNhap.html">
                                  <li class="article-area">
                                      <p style="color:rgb(0,183,178);">

                                      <span class="btn btn-success btn-sm">Đăng nhập ngay</span>                                     
                                      </p>
                                  </li>
                              </a>
                            </ul>
