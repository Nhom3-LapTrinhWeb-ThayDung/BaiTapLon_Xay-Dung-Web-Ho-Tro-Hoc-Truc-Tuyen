...
<title>
	Các khóa học đã đăng ký | Study Funny
</title>
...
<div style="float:left;padding-left:8px;padding-right:20px"  >
    <img class="capcha"  src="http://viettelstudy.vn/uControls/Capcha/capchaImage.aspx?len=5&id=GopY" title="Lấy mã khác" alt="ViettelStudy" /> 
                	...
                	<input type="hidden" name="TokenCSRF_GopYBaiHoc" value="6D190317B8FF6C2D945E787D2179A21873D9B079877780863F843E12B3525D696FADE37E2382213D0E26B13F732B4AB943BA7266BDB28C8BBCFC46D90DCDA122" />
                </div>
            </div>
...
<div class="vts-highlight">
    <h1 class="vts-highlight-header">
        <a class="vts-highlight-header">CÁC KHÓA HỌC ĐÃ ĐĂNG KÝ</a>
    </h1>
    <div class="vts-highlight-wrap">
                ...
                <div class="vts-highlight-item">
                    <h3 class="vts-highlight-h3">
                        <a 
                         title="Lập trình web" class="vts-highlight-lnk">
                            Lập trình web
                        </a>
                    </h3>
                    <a  title="Lập trình web" class="vts-highlight-lnk-img">
                        <img src="Images/Web-Developer.jpg" alt="Lập trình web">
                    </a>
                ...
                <div class="vts-highlight-item">
                    <h3 class="vts-highlight-h3">
                        <a 
                         title="Kỹ thuật lập trình" class="vts-highlight-lnk">
                            Kỹ thuật lập trình
                        </a>
                    </h3>
                    <a  title="Kỹ thuật lập trình" class="vts-highlight-lnk-img">
                        <img src="Images/Ky-thuat-lap-trinh.jpg" alt="Kỹ thuật lập trình">
                    </a>
                    &nbsp;<p class="vts-highlight-statistic">
                ...
                <div class="vts-highlight-item">
                    <h3 class="vts-highlight-h3">
                        <a 
                         title="Giao tiếp cơ bản" class="vts-highlight-lnk">
                            Giao tiếp cơ bản
                        </a>
                    </h3>
                    <a  title="Giao tiếp cơ bản" class="vts-highlight-lnk-img">
                        <img src="Images/Giao-tiep-co-ban.jpg" alt="Giao tiếp cơ bản">
                    </a>
                    &nbsp;<p class="vts-highlight-statistic">
                ...
                <div class="vts-highlight-item">
                    <h3 class="vts-highlight-h3">
                        <a href="XemDeCuong_DeThiTOEIC.jsp" 
                         title="Đề thi TOEIC" class="vts-highlight-lnk">
                           Đề thi TOEIC
                        </a>
                    </h3>
                    <a href="XemDeCuong_DeThiTOEIC.jsp"  title="Đề thi TOEIC" class="vts-highlight-lnk-img">
                        <img src="Images/Toeic-vocabulary.png" alt="Đề thi TOEIC">
                    </a>
                    &nbsp;<p class="vts-highlight-statistic">
                ...
                <div class="vts-highlight-item">
                    <h3 class="vts-highlight-h3">
                        <a 
                         title="Toán rời rạc và lý thuyết đồ thị" class="vts-highlight-lnk">
                            Toán rời rạc và lý thuyết đồ thị
                        </a>
                    </h3>
                    <a  title="Toán rời rạc và lý thuyết đồ thị" class="vts-highlight-lnk-img">
                        <img src="Images/math.jpg" alt="Toán rời rạc và lý thuyết đồ thị">
                    </a>
                    &nbsp;<p class="vts-highlight-statistic">
                ...
                <div class="vts-highlight-item">
                    <h3 class="vts-highlight-h3">
                        <a 
                         title="Ngữ pháp tiếng Nhật" class="vts-highlight-lnk">
                            Ngữ pháp tiếng Nhật
                        </a>
                    </h3>
                    <a  title="Ngữ pháp tiếng Nhật" class="vts-highlight-lnk-img">
                        <img src="Images/Ngu-phap-tieng-Nhat.jpg" alt="Ngữ pháp tiếng Nhật">
                    </a>
                    &nbsp;<p class="vts-highlight-statistic">
    ...
    $(function() {
        ...
        $("#btnRegisterRevMail").click(function() {
            ...
            if (validateEmail(txtEmail)) {
                ...
                {
                    mEmail: txtEmail,
                    TokenEmail: "89273DBCF724092E1D33E5108ACF3591EDDC88770C3DB0CFBB79A7BD65EDE3BB6332CBF06C90E0861AC8FFB3C493285269AD2FAC2606090D5937B584FF0CDEB0"
                },
            ...
            <div id="login_pnLogin">
                    ...
                    <div class="bpc-row" style="margin-top: 0px;">
                        <span class="sp-left"></span><span class="sp-right">
                            ...
                            <input type="hidden" name="TokenCSRF_Login" value="6A7200CA5E8286E488250E3E238AC62496B5270CF8E5035E7B34129005203BFF39DFC219CB27E8D0A43A1E87B1D6DB1F1FF04FBB94DDCCA980ED1ECF2577DFE8" />
                        </span>
