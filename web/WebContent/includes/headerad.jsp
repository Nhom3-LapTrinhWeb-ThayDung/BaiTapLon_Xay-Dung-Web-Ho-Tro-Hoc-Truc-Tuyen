...
<div id="header">
	...
	<div id="header-menu" style="background: rgb(0, 183, 178);">
		...
		<ul class="ul-menu-header">
			...
			<li class="li-menu-header"><a class="lnk-menu-header"
				href="admin_quanlytaikhoan.jsp"> QUẢN LÝ TÀI KHOẢN </a></li>
			<li class="li-menu-header"><a class="lnk-menu-header"
				href="admin_danhsachlhocdkymo.jsp"> QUẢN LÝ KHÓA HỌC </a>
				...
				<li class="li-menu-header"><a class="lnk-menu-header"
				href="admin_quanlydanhsachchodangky.jsp"> QUẢN LÝ DANH SÁCH ĐĂNG KÝ KHÓA HỌC</a></li>
		</ul>
	</div>
</div>
